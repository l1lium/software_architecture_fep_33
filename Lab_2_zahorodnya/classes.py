...
# IPort Interface (Abstract Class)
class IPort(ABC):
    @abstractmethod
...
# IShip Interface (Abstract Class)
class IShip(ABC):
    @abstractmethod
...
class Port(IPort):
    def __init__(self, ID, latitude, longitude):
        ...
        self.containers = []  # List of containers in the port
        self.history = []  # List of ships that visited this port
        self.current = []  # List of ships currently at this port
    ...
    def getDistance(self, other_port):
        # Simple geospatial distance formula (Haversine) could be used
        pass
